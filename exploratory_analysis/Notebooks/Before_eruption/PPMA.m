...
saveas(gcf, folder_path + 'PPMA_scores_avg_mag_2PCs', 'epsc');
saveas(gcf, folder_path + 'PPMA_scores_avg_mag_2PCs', 'png');
...
saveas(gcf, folder_path + 'PPMA_scores_avg_mag_1PC', 'epsc');
saveas(gcf, folder_path + 'PPMA_scores_avg_mag_1PC', 'png');
