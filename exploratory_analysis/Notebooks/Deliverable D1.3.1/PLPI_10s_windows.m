...
index = find(strcmp({textHandles.String}, '19-Sep-2021 10:17:20'));
set(textHandles(index), 'Position', [1.5e8, 0.1e8,]);

index = find(strcmp({textHandles.String}, '19-Sep-2021 09:52:10'));
set(textHandles(index), 'Position', [1.4e8, 2.7e8,]);


%%
saveas(gcf, folder_path + 'PLPI_scores_before_after_IGN_no_eq', 'epsc');
saveas(gcf, folder_path + 'PLPI_scores_before_after_IGN_no_eq', 'png');
