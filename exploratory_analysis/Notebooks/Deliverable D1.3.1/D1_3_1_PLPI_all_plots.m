...
sgtitle("PLPI oMEDA - Before vs After the eruption")
for i = 1:3
    subplot(3,1,i);
    ax = gca;
...
%%
saveas(gcf, folder_path + 'PLPI_oMEDA_before_vs_after', 'epsc');
saveas(gcf, folder_path + 'PLPI_oMEDA_before_vs_after', 'png');
