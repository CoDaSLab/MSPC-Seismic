...
def test_monitoring_2nocs(noc_ppma1, noc_ppma2):
    ...
    with open(config_path, "r", encoding="utf-8") as f:
        config = json.load(f)
        config["monitoring"]["starttime"] = '2025-06-17T12:03:20Z'
        config["monitoring"]["endtime"] = '2025-06-17T12:04:10Z'
    ...
    with open(config_path, "r", encoding="utf-8") as f:
        config = json.load(f)
        config["monitoring"]["starttime"] = '2025-06-17T12:04:10Z'
        config["monitoring"]["endtime"] = '2025-06-17T12:05:00Z'
    with open(config_path, "w", encoding="utf-8") as f:
        json.dump(config, f, indent=4)
