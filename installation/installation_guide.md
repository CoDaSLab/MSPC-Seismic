...
This will open the enviroment, where you have all the package installations needed to use the software. Make sure you are using the enviroment before you try to run the software. This is the only step in the installation guide that you may need to repeat.
