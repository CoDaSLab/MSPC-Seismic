...
"""
function: get_filenames(start, end, sensor, channel, path = "digivolcan/database/Available_files.csv")
...
def get_filenames(start, end, sensor, channel, path = "digivolcan/database/Available_files.csv"):
...
"""
function: check_sensors(start, end, tol = 0, pathfile = "digivolcan/database/Available_times.csv",
...
"""
def check_sensors(start, end, tol = 0, pathfile = "digivolcan/database/Available_times.csv",
                  sensors = ['DAS', 'PLPI_HHE', 'PLPI_HHN', 'PLPI_HHZ', 'PPMA_HHE', 'PPMA_HHN', 'PPMA_HHZ'],
...
endtime:   {end}
    ...
    df_time = pd.read_csv("digivolcan/database/Available_times.csv")
